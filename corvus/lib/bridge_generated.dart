...
abstract class Native {
  ...
  Future<String> createchannel3({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kCreatechannel3ConstMeta;
}
...
class NativeImpl extends FlutterRustBridgeBase<NativeWire> implements Native {
  ...
  Future<String> createchannel3({dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_createchannel3(port_),
        parseSuccessData: _wire2api_String,
        constMeta: kCreatechannel3ConstMeta,
        argValues: [],
        hint: hint,
      ));
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_createchannel3(
    int port_,
  ) {
    return _wire_createchannel3(
      port_,
    );
  }

  late final _wire_createchannel3Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_createchannel3');
  late final _wire_createchannel3 =
      _wire_createchannel3Ptr.asFunction<void Function(int)>();
